...
for i in tqdm(range(1,101)):
    ...
    save.save_object(min_cost_values, "cost_value_array_zipf_{}".format(i), skip_dialogue = True)
    save.save_object(cell_areas, "cell_area_array_zipf_{}".format(i), skip_dialogue = True)
    #fig = plt.figure()
